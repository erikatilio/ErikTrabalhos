...
def game():
    ...
    def carregar_inimigos():
        posx = 15
        for x in range(1, 10):
            invasor = inimigo(posx, -80, 5, "imagens/alien01.png", "imagens/alien01(2).png")
        ...
        posx = 15
        for x in range(1, 10):
            invasor = inimigo(posx, -380, 5, "imagens/alien03.png", "imagens/alien03(2).png")
            lista_inimigos.append(invasor)
            posx += 100

        posx = 8
        for x in range(1, 10):
            invasor = inimigo(posx, -480, 5, "imagens/nave2.png", "imagens/nave2(2).png")
            lista_inimigos.append(invasor)
            posx += 100

        posx = 15
        for x in range(1, 10):
            invasor = inimigo(posx, -580, 5, "imagens/alien01.png", "imagens/alien01(2).png")
            lista_inimigos.append(invasor)
            posx += 100

        posx = 15
        for x in range(1, 10):
            invasor = inimigo(posx, -680, 5, "imagens/alien03.png", "imagens/alien03(2).png")
            lista_inimigos.append(invasor)
            posx += 100

        posx = 15
        for x in range(1, 10):
            invasor = inimigo(posx, -780, 5, "imagens/alien02.png", "imagens/alien02(2).png")
            lista_inimigos.append(invasor)
            posx += 100

        posx = 15
        for x in range(1, 10):
            invasor = inimigo(posx, -880, 5, "imagens/alien01.png", "imagens/alien01(2).png")
            lista_inimigos.append(invasor)
            posx += 100

        posx = 15
        for x in range(1, 10):
            invasor = inimigo(posx, -920, 5, "imagens/alien03.png", "imagens/alien03(2).png")
            lista_inimigos.append(invasor)
            posx += 100

        posx = 15
        for x in range(1, 10):
            invasor = inimigo(posx, -980, 5, "imagens/alien02.png", "imagens/alien02(2).png")
            lista_inimigos.append(invasor)
            posx += 100

        posx = 15
        for x in range(1, 10):
            invasor = inimigo(posx, -1090, 5, "imagens/nave2.png", "imagens/nave2(2).png")
            lista_inimigos.append(invasor)
            posx += 100
