...
def game():
    ...
    class inimigo(pygame.sprite.Sprite):
        ...
        def __descendo(self):
            if self.maxDescida == self.rect.top:
                self.contador = 0
                self.maxDescida = self.rect.top + 4
    ...
    def carregarInimigos():
        posx = 20
        for x in range(1,10):
            invasor = inimigo(posx,-10,5,"imagens/alien01.png","imagens/alien01(2).png")
            listaInimigos.append(invasor)
            posx += 100
        posx = 20
        for x in range(1, 10):
            invasor = inimigo(posx, -160, 5,"imagens/alien02.png","imagens/alien02(2).png")
            listaInimigos.append(invasor)
            posx += 100
        posx = 20
        for x in range(1, 10):
            invasor = inimigo(posx, -280, 5,"imagens/alien03.png","imagens/alien03(2).png")
            listaInimigos.append(invasor)
            posx += 100
